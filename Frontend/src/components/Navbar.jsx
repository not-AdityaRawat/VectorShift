...
const [activeNodes, setActiveNodes] = useState(['input', 'output', 'text', 'note']);
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-stone-200/50 bg-gradient-to-r from-white via-stone-50 to-white backdrop-blur-xl shadow-sm ">
      <div className="flex items-center justify-between bg-cyan-400 px-6 py-3">
        {/* Left Section - Breadcrumb */}
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 text-sm font-medium">
            <button className="text-stone-600 hover:text-stone-900 transition-colors duration-200 hover:scale-105 transform">
              Workbooks
            </button>
          ...
          <button className="ml-2 text-stone-500 hover:text-stone-700 transition-colors p-1 rounded-md hover:bg-stone-100">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="ml-2 text-stone-500 hover:text-stone-700 transition-colors p-2 rounded-md hover:bg-stone-100">
